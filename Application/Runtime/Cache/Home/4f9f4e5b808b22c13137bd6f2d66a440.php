...
<link rel="stylesheet" type="text/css" href="/Public/Login/css/findPassword.css" />
...
<script type="text/javascript" src="/Public/Login/js/findPassword.js"></script>
</head>
...
<div id="InfoPlatform_mainRight">
	<div class="step" >
		...
		<div class="text">
			请确认你是否真的记不得密码，若确定，请点击以下按钮。
			系统会把随机的新的密码发往你的账户邮箱，请查收。
			并且尽快到易易网<b> 更新密码 </b>！
		</div>
		<div class="controller">
			...
			<button type="submit" class="btn btn-default" id="mailpassword">发送新密码</button>
		</div>
	</div>
