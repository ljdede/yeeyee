...
<div id="InfoPlatform_mainRight">
	<div class="infoStream creator">
		<form action="/Home/Index/creator" method="post" >
			<div class="titleBox">
				<input type="text" name="title" class="form-control" id="titleBox_title" placeholder="输入物品名称">
			...
			<div class="optionBox" style="display:none;">
				...
				<div class="detailBox">
					<div class="catagoryBox">
						...
						<input type="hidden" value="1" id="catagoryBox_catagory_1" />
						<input type="hidden" value="2" id="catagoryBox_catagory_2" />
					</div>
					<div class="linkBox">
						<div class="header">添加超链接：</div>
						<div class="body">
							<input type="text" name="url" class="form-control" id="linkBox_link" placeholder="输入原信息的网址">
						</div>
					</div>
				</div>
