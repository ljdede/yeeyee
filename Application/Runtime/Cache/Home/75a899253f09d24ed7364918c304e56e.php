			...
			<div class="tab-pane fade" id="setting_contact">
				<form action="/Home/Setup/setting_contact" method="post">
					<div class="input-group">
						...
						<input type="text" name="mobileNumber" class="form-control" placeholder="<?php echo ($user["mobileNumber"]); ?>" value="<?php echo ($user["mobileNumber"]); ?>">
					</div>
					<div class="input-group">
						<span class="input-group-addon">手机短号</span>
						<input type="text" name="mobileNumber_short" class="form-control" placeholder="<?php echo ($user["mobileNumber_short"]); ?>" value="<?php echo ($user["mobileNumber_short"]); ?>">
					</div>
					<div class="input-group">
						<span class="input-group-addon">QQ号码</span>
						<input type="text" name="qq" class="form-control" placeholder="<?php echo ($user["qq"]); ?>" value="<?php echo ($user["qq"]); ?>">
					</div>
					<div class="input-group">
						<span class="input-group-addon">微信号码</span>
						<input type="text" name="weixin" class="form-control" placeholder="<?php echo ($user["weixin"]); ?>" value="<?php echo ($user["weixin"]); ?>">
					</div>
					<div class="input-group">
						<span class="input-group-addon">微博网址</span>
						<input type="text" name="weibo" class="form-control" placeholder="<?php echo ($user["weibo"]); ?>" value="<?php echo ($user["weibo"]); ?>">
					</div>
					<div class="input-group">
						<span class="input-group-addon">备注</span>
						<input type="text" name="notes" class="form-control" placeholder="<?php echo ($user["notes"]); ?>" value="<?php echo ($user["notes"]); ?>">
					</div>
					<div class="controller">
						<button type="submit" class="btn btn-primary btn-lg">修改</button>
					</div>
